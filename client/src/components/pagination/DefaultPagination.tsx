...
function DefaultPagination({ total, limit, page, delta = 2, onPageChange }: TProps) {
    ...
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {pages.map((page) => (
        <button
          ...
          className={`${currentPage === page ? "bg-secondary_color text-black" : "bg-primary_color text-white "} size-10 `}
        >
          {page}
        </button>
      ))}

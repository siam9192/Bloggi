...
const getAuthorOverviewData = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield overview_service_1.default.getAuthorOverviewDataFromDB(req.user);
    (0, response_1.sendSuccessResponse)(res, {
        statusCode: http_status_1.default.OK,
        message: "Overview data retrieved successfully",
        data: result,

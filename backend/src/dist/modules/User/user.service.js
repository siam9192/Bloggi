  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((trClient) =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const userProfile = Object.assign(Object.assign({}, data.name), {
          profile_photo: "dee",
        ...
        return Object.assign(Object.assign({}, userCreatedData), {
    ...
    const result = yield prisma_1.default.$transaction((trClient) =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const authorSocialLinks = data.social_links.map((ele) =>
          Object.assign(Object.assign({}, ele), {
...
const ChangeUserStatusIntoDB = (data) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getUsersFromDB = (query, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm, startDate, endDate } = query,
      filterData = __rest(query, ["searchTerm", "startDate", "endDate"]);
...
const softDeleteUserIntoDB = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Check user existence
    yield prisma_1.default.user.findUniqueOrThrow({
      where: {

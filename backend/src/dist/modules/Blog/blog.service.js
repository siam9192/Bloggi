...
const createBlogIntoDB = (userId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { tags } = payload,
      othersBlogData = __rest(payload, ["tags"]);
    ...
    const result = yield prisma_1.default.$transaction((trClient) =>
      __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        ...
        const createdBlog = yield trClient.blog.create({
          data: Object.assign(
            Object.assign({ author_id: authorData.id }, othersBlogData),
            { slug },
          ),
        });
        if (tags && tags.length) {
          const tags =
            (_a = payload.tags) === null || _a === void 0
              ? void 0
              : _a.map((tag) => ({
                  name: tag,
...
const getBlogByIdFromDB = (authUser, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
    const blog = yield prisma_1.default.blog.findUnique({
      where: {
    ...
    if (
      authUser.role === client_1.UserRole.Author &&
      authUser.authorId !==
        (blog === null || blog === void 0 ? void 0 : blog.author_id)
    ) {
      throw new AppError_1.default(
...
const getBlogsFromDB = (authUser, filter, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getBlogForReadBySlugFromDB = (authUser, slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Find blog by slug
    const blog = yield prisma_1.default.blog.findUnique({
      where: {
    ...
    if (authUser && authUser.role === client_1.UserRole.Reader) {
      ...
      if (blog.is_premium) {
        const currentSubscription =
          yield prisma_1.default.subscription.findFirst({
            where: {
              reader: {
                user_id: authUser.id,
              },
    ...
    const { author } = blog,
      othersData = __rest(blog, ["author"]);
    const data = Object.assign(Object.assign({}, othersData), {
      author: {
...
const getMyBlogsFromDB = (authUser, filterOptions, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm, categories, type, startDate, endDate } = filterOptions,
      otherFilterOptions = __rest(filterOptions, [
        "searchTerm",
        "categories",
        "type",
        "startDate",
...
const getBlogsForManageFromDB = (query, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateBlogByIdFromDB = (id, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { deleted_tags, new_tags } = data,
      others_data = __rest(data, ["deleted_tags", "new_tags"]);
...
const getTrendingBlogsFromDB = (categoryId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getRelatedBlogsFromDB = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const blog = yield prisma_1.default.blog.findUnique({
      where: {
        slug,
...
const getBlogAnalyzingDataFromDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
    const blog = yield prisma_1.default.blog.findUnique({
      where: {

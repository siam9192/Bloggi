...
const getUserProfileByIdFromDB = (id) =>
...
const updateMyProfileIntoDB = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    ...
    if (role === client_1.UserRole.Reader) {
      ...
      profile_validation_1.default.UpdateAuthorProfileValidation.parse(
        req.body,
      );
      const _a = req.body,
        { social_links } = _a,
        data = __rest(_a, ["social_links"]);
      result = prisma_1.default.$transaction((trClient) =>
        __awaiter(void 0, void 0, void 0, function* () {
          if (data) {

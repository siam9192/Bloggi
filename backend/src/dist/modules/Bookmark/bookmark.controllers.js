...
const createBookmark = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield bookmark_service_1.default.createBookmarkIntoDB(req.user, req.body);
...
const deleteBookmark = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield bookmark_service_1.default.deleteBookmarkFromDB(req.user, req.params.blogId);
    (0, response_1.sendSuccessResponse)(res, {
        statusCode: http_status_1.default.OK,
...
const getMyBookmarksFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const paginationOptions = (0, pick_1.default)(req.query, constant_1.paginationOptionKeys);
    const result = yield bookmark_service_1.default.getMyBookmarksFromDB(req.user, paginationOptions);
    (0, response_1.sendSuccessResponse)(res, {
        statusCode: http_status_1.default.OK,

...
const createFollowerInto = (user, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!reader) {
        throw new AppError_1.default(http_status_1.default.OK, "Reader not found");
    }
    ...
    if (!author) {
        throw new AppError_1.default(http_status_1.default.OK, "Author not found");
    }
...
const deleteFollowerFromDB = (user, author_id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!follower) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, "Follower not found");
    }
...
const getAuthorFollowersFromDB = (authorId, filterData, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const total = yield prisma_1.default.follower.count({ where: whereConditions });
    return {
        data,
        meta: {
            limit,
...
const getMyFollowersFromDB = (authUser, filter, options) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, skip, page, sortBy, sortOrder } = (0, paginationHelper_1.calculatePagination)(options);
...
const getMyFollowingAuthorsFromDB = (authUser, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, skip, page } = (0, paginationHelper_1.calculatePagination)(paginationOptions);
    const whereConditions = {
        reader: {
            user_id: authUser.id,
        },
...
const changeFollowerStatus = (authUser, payload) => __awaiter(void 0, void 0, void 0, function* () {

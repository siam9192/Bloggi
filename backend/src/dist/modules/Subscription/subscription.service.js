...
const initPlanSubscription = (authUser, payload) =>
    ...
    const result = yield prisma_1.default.$transaction((tx) =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { transactionId, paymentId, paymentUrl } =
          yield payment_service_1.default.initSubscriptionPayment(
            tx,
            paymentPayload,
          );
        const start_at = new Date();
        const end_at = new Date(
          new Date().getTime() + hoursDif * 60 * 60 * 1000,
        );
...
const getMyCurrentSubscription = (authUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getSubscriptionsFromDB = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {

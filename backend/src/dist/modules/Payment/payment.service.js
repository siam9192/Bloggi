...
const initSubscriptionPayment = (tx, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const transaction_id = yield (0,
    payment_function_1.generateTransactionId)();
...
const validateSSLSubscriptionPayment = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const validateStripeSubscriptionPayment = (event) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!event || event.type)
      throw new AppError_1.default(
    ...
    switch (event.type) {
      ...
      case "checkout.session.async_payment_failed":
        yield PaymentServices.manageCanceledOrFailedPayment(
...
const manageCanceledOrFailedPayment = (transactionId, status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const payment = yield prisma_1.default.payment.findUnique({
      where: {
...
const getPaymentsFromDB = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { skip, limit, page, sortBy, sortOrder } = (0,
    paginationHelper_1.calculatePagination)(paginationOptions);
    const andConditions = [];

...
const validateSSLSubscriptionPayment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield payment_service_1.default.validateSSLSubscriptionPayment(req.query);
...
const validateStripeSubscriptionPayment = (0, catchAsync_1.default)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result =
        yield payment_service_1.default.validateStripeSubscriptionPayment(
          req.body,
        );
      (0, response_1.sendSuccessResponse)(res, {
        statusCode: http_status_1.default.OK,
...
const getPayments = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield payment_service_1.default.getPaymentsFromDB(
      filter,
      paginationOptions,
    );
    (0, response_1.sendSuccessResponse)(res, {

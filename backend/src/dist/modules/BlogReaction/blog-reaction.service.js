...
const UpsertBlogReactionIntoDB = (authUser, payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const getMyBlogReactionsFromDB = (authUser, blogId) => __awaiter(void 0, void 0, void 0, function* () {
...
const getBlogReactionsFromDB = (authUser, blogId) => __awaiter(void 0, void 0, void 0, function* () {
    // Type cast blogId  string => number
    blogId = Number(blogId);
    return yield prisma_1.default.blogReaction.findUnique({
        where: {

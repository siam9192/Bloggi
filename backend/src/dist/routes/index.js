...
const follower_route_1 = __importDefault(
  require("../modules/Follower/follower.route"),
);
const bookmark_route_1 = __importDefault(
  require("../modules/Bookmark/bookmark.route"),
);
const comment_route_1 = __importDefault(
  require("../modules/Comment/comment.route"),
);
const comment_reaction_route_1 = __importDefault(
  require("../modules/CommentReaction/comment-reaction.route"),
);
const subscription_route_1 = __importDefault(
...
const blog_reaction_route_1 = __importDefault(
  require("../modules/BlogReaction/blog-reaction.route"),
);
